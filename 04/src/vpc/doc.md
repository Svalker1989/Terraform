...
| <a name="module_module_vpc"></a> [module\_vpc](#module\_module\_vpc) | ./vpc | n/a |
...
| <a name="input_vms_ssh_key"></a> [vms\_ssh\_key](#input\_vms\_ssh\_key) | ssh-key | `string` | n/a | yes |
